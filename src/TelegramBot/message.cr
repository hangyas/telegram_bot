...
class Message
  JSON.mapping({
    ...
    delete_chat_photo:     {type: Boolean, nilable: true}, # must be true
 group_chat_created:    {type: Boolean, nilable: true}     # must be true
  })
end
